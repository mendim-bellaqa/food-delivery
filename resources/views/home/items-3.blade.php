    ...
    <div class="pt-16 px-10 grid lg:grid-cols-5 pb-20">
        ...
        <main class="lg:col-span-4">
            ...
            <button class="font-bold rounded-full bg-white mr-2 py-2 px-3 shadow block sm:hidden mt-5 w-full cart"><i
                ...
                items - $17.50</button>
            <div class="mt-16">
                <div><span class="font-bold text-2xl md:text-4xl">Ninja Pizza</span><img src="images/pizza.svg"
                        class="h-6 w-6 md:h-10 md:w-10 mb-3 ml-1 md:ml-2 inline-flex"></div>

                <div class="mt-5 grid md:grid-cols-2 xl:grid-cols-3 sm:grid-cols-2 gap-12">
                        ...
                        <div class="grid grid-cols-2 gap-8">
                            <div>
                                <img src="images/pizza.png" alt="pizza"
                                    class="w-40 p-4 transform hover:scale-90 transition duration-300">
                            </div>
                            <div>
                                <span class="font-bold text-xl">Pepperoni love</span>
                                <span class="block text-gray-600 text-sm">Pepperoni, Mozzarella, Tomato sauce</span>
                                <span class="block text-custom-yellow mt-4 font-bold text-3xl">$ 1.00
                                    <small class="text-sm">/slice</small></span>
                            </div>
                        </div>
                    </div>
                    <!--card end-->
        ...
        <aside
            ...
            <div class="p-8">
                ...
                <main class="text-center">
                    <img src="images/pizza.png" alt="burger" class="w-56 mx-auto mt-16 mb-8">
                    <span class="font-bold text-3xl">Pepperoni love</span>
                    <span class="block text-gray-600 text-sm">Pepperoni, Mozzarella, Tomato sauce</span>
                    <span class="block text-custom-yellow mt-6 font-bold text-3xl">$ 1.00 <small
                            class="text-sm">/slice</small></span>
                ...
                <main class="text-center font-bold">
                    ...
                    <table class="table-auto mx-auto mt-10">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border px-4 py-2">Pepperoni love</td>
