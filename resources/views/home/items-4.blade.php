    ...
    <div class="pt-16 px-10 grid lg:grid-cols-5 pb-20">
        ...
        <main class="lg:col-span-4">
            ...
            <button class="font-bold rounded-full bg-white mr-2 py-2 px-3 shadow block sm:hidden mt-5 w-full cart"><i
                ...
                items - $17.50</button>
            <div class="mt-16">
                <div><span class="font-bold text-2xl md:text-4xl">Ninja Salad</span><img src="images/salad.svg"
                ...
                <div class="mt-5 grid md:grid-cols-2 xl:grid-cols-3 sm:grid-cols-2 gap-12">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-3 hover:shadow-lg item">
                        <div class="grid grid-cols-2 gap-8">
                            ...
                            <div>
                                <span class="font-bold text-xl">Fruit salad</span>
                                <span class="block text-gray-600 text-sm">Mango, Orange, Passion fruit</span>
        ...
        <aside
            ...
            <div class="p-8">
                ...
                <main class="text-center">
                    <img src="images/salad.png" alt="burger" class="w-56 mx-auto mt-16 mb-8">
                    <span class="font-bold text-3xl">Fruit salad</span>
                    <span class="block text-gray-600 text-sm">Mango, Orange, Passion fruit</span>
                    <span class="block text-custom-yellow mt-6 font-bold text-3xl">$ 6.30</span>
