    ...
    <div class="pt-16 px-10 grid lg:grid-cols-5 pb-20">
        ...
        <main class="lg:col-span-4">
            ...
            <button class="font-bold rounded-full bg-white mr-2 py-2 px-3 shadow block sm:hidden mt-5 w-full cart"><i
                ...
                items - $17.50</button>
            <div class="mt-16">
                <div><span class="font-bold text-2xl md:text-4xl">Ninja Juice</span><img src="images/orange-juice.svg"
                        class="h-6 w-6 md:h-10 md:w-10 mb-3 ml-1 md:ml-2 inline-flex"></div>

                <div class="mt-5 grid md:grid-cols-3 lg:grid-cols-4 sm:grid-cols-2 gap-12">

                    <!--card-->
                    <div class="bg-white rounded-lg shadow-md p-3 hover:shadow-lg item">
                        <img src="images/juice.png" alt="burger"
                            class="w-full transform hover:scale-90 transition duration-300">
                        <div class="m-3 text-center">
                            <span class="font-bold text-xl">Sanguine refresh</span>
                            <span class="block text-gray-600 text-sm">sanguine juice, Orange juice, Mint</span>
                            <span class="block text-custom-yellow mt-10 font-bold text-3xl">$ 2.50</span>
                        </div>
                    </div>
                    <!--card end-->
